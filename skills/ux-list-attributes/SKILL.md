---
name: ux-list-attributes
description: "Step 4.1 of Sketch the Solution. List exhaustive attributes for every entity from stories, surveys, and flow. Use when asked to 'list attributes', 'entity attributes', 'data attributes', or 'attribute inventory'."
---
