...
description: "Step 7.1 of Sketch the Solution. Create structured user testing session plan with per-screen questions. Use when asked to 'user testing', 'test plan', 'feedback session', 'validate with users', or 'customer feedback'."
---

# UX Step 7.1 — User Testing
...
2. **Generate per-screen questions:**
...
3. **Create benefit/price anchor capture template:**
...
4. **Define the outreach email template:**
...
- **NEVER email the prototype** — always walk through live on screen share
- Always record feedback sessions
- Start with the most interested/comfortable prospect
- Listen more than you talk — dig deep like in idea extraction
- Track tangible value statements ("saves X hours", "replaces Y employees")
