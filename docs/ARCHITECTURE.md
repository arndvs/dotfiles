...
graph TB
    subgraph "~/dotfiles (source of truth)"
        ...
        SKILLS["skills/<br/>24 public workflows"]
        AGENTS["agents/<br/>7 subagent personas"]
        CMDS["commands/<br/>10 slash dispatchers"]
...
| [skills/](../skills/README.md) | Multi-step workflow definitions (T4) | 24 public skills, triggered by task description |
| [agents/](../agents/README.md) | Read-only subagent personas | 7 agents across 3 model tiers (Haiku/Sonnet/Opus) |
| [commands/](../commands/README.md) | `/slash` command dispatchers | 10 commands, each loads one skill |
